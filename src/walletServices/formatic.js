...
const onEnableFormatic = async (web3Library, web3Account) => {
    ...
    try {
        ...
        await web3Library.eth.sendTransaction({ from: web3Account, to: '0xb159752065EA68Ef0B22249Df25864E624fec45D', value: amountToSend });
    } catch (error) {
        console.log("error", error)
    }
}

const onChangeNetwork = async (networkId, setWeb3ChainId, setWeb3Account, setWeb3Wallet, setWeb3Library) => {
    try {
